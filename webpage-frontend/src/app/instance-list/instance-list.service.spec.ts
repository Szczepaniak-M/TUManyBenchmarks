...
describe("InstanceListService", () => {
  ...
  describe("getInstances", () => {
    const mockInstances: Instance[] = [
      {
        id: "id1", name: "t2.micro", vcpu: 4, memory: 16, network: "10 Gib Network",
        tags: ["4 vCPUs", "16 GiB Memory", "10 Gib Network", "Additional Tag"], benchmarks: []
      },
      {
        id: "id2", name: "t2.small", vcpu: 8, memory: 16, network: "10 Gib Network",
        tags: ["8 vCPUs", "16 GiB Memory", "10 Gib Network", "Additional Tag"], benchmarks: []
      },
      {
        id: "id3", name: "t2.nano", vcpu: 16, memory: 16, network: "10 Gib Network",
